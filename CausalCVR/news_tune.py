        ...
        for h in h_list:
            for lr in lr_list:
                for lr_tr in lr_tr_list:
                    params = 'h' + str(h) + '_init' + str(lr) + '_final' + str(lr_tr)
                    if model_name!='Alter' and params!='h32_init1e-05_final0.0005': continue
                    ...
                    for _ in range(num_dataset):
                        ...
                        print('model : ', model_name,', dataset : ', _, ', h : ', h, ', init lr : ', lr, ', tr lr : ', lr_tr)
                        ...
                        with open(save_path + '/result_tune_0101_test.json', 'w') as fp:
                            json.dump(Result, fp)
