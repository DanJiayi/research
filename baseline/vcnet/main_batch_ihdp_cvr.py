...
if __name__ == "__main__":
    ...
    # i/o
    parser.add_argument('--data_dir', type=str, default='/root/test01/research/CausalCVR/dataset/ihdp', help='dir of data_utils matrix')
    parser.add_argument('--data_split_dir', type=str, default='/root/test01/research/CausalCVR/dataset/ihdp/eval', help='dir of data_utils split')
