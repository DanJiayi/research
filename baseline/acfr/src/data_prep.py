...
def create_synthetic_data(dataset="tcga", dir='data_utils/tcga/', run_n=0, selection_bias=2):
    ...
    if os.path.exists(curr_dir + "/train.csv") \
        ...
        logger.info(f"Train, validation, test for tcga data_utils {run_n} exist.")
    else:
